	...
	defaults: {
		...
		highlight: function( element, errorClass, validClass ) {
			if ( element.type === "radio" || element.type === "select-one") {
				...
				var elmt = $( element ).parent();
				elmt.find("span[class^='glyphicon']").remove();
				elmt.prepend("<span class='glyphicon glyphicon-remove form-control-feedback'></span>");	
				elmt.addClass( errorClass ).removeClass( validClass );
			}
		},
		unhighlight: function( element, errorClass, validClass ) {
			if ( element.type === "radio" || element.type === "select-one") {
				...
				var elmt = $( element ).parent();
				elmt.find("span[class^='glyphicon']").remove();
				elmt.prepend("<span class='glyphicon glyphicon-ok form-control-feedback'></span>");	
				elmt.removeClass( errorClass ).addClass( validClass );
			}
		}
	},
