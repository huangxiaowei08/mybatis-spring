...
<body>
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">系统启动修改</li>
  </ol>
  <div id="goExam" class="panel-collapse collapse in">
  <form id="form1" class="form-horizontal" >
      <div class="form-group">
        <label for="exam_paper_name" class="col-sm-2 control-label"><span class="not-null">*</span>启动编码</label>
        <div class="col-sm-8 has-feedback">
            <input type="text" class="form-control" id="startup_no" name="startup_no" placeholder="启动编码" disabled="disabled">
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="row text-center">
        <button type="button" name="sysStartconfigModify.do" onclick="add(this)" class="btn btn-primary btn-sm">
