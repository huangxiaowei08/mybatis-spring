	...
	<div id="goExam" class="panel-collapse collapse in">
		<form id="form1" class="form-horizontal">
			<div class="form-group">
				<label for="exam_paper_name" class="col-sm-2 control-label"><span
					class="not-null">*</span>数据库编码</label>
				<div class="col-sm-8 has-feedback">
					<input type="text" class="form-control" id="database_no"
						name="database_no" placeholder="数据库编码" disabled="disabled">
				</div>
			</div>
			<div class="form-group">
				<label for="exam_paper_name" class="col-sm-2 control-label"><span
					class="not-null">*</span>数据库名称</label>
				<div class="col-sm-8 has-feedback">
					<input type="text" class="form-control" id="database_name"
						name="database_name" placeholder="数据库名称">
				</div>
			</div>
			<div class="form-group">
				<label for="ui_input_select" class="col-sm-2 control-label"><span
					class="not-null">*</span>数据库类型</label>
				<div class="col-sm-8 has-feedback">
					<select name="database_type" id="database_type"
						class="form-control"
						onchange="configProType(this.value,'driver_class','')">
						<option value=''></option>
			...
			<div class="form-group">
				<label for="ui_input_select" class="col-sm-2 control-label"><span
					class="not-null">*</span>连接方式</label>
				<div class="col-sm-8 has-feedback">
					<n:select id="connect_type" up_no="connect_type"
						value="connect_type" />
				</div>
			</div>
			<div class="form-group">
				<label for="exam_paper_name" class="col-sm-2 control-label"><span
					class="not-null">*</span>数据库地址</label>
				<div class="col-sm-8 has-feedback">
			...
			<div class="form-group">
				<label for="exam_paper_name" class="col-sm-2 control-label"><span
					class="not-null">*</span>数据库用户名</label>
				<div class="col-sm-8 has-feedback">
			...
			<div class="form-group">
				<label for="exam_paper_name" class="col-sm-2 control-label"><span
					class="not-null">*</span>数据库密码</label>
				<div class="col-sm-8 has-feedback">
			...
			<div class="form-group" id="driver_class">
				<label for="exam_paper_name" class="col-sm-2 control-label"><span
					class="not-null">*</span>数据库驱动</label>
				<div class="col-sm-8 has-feedback">
					<input type="text" class="form-control" id="driver_class"
						name="driver_class" placeholder="数据库驱动">
				</div>
			</div>
			<div class="row text-center">
				<button type="button" name="goModifySavedataconfig.do"
					onclick="add(this)" class="btn btn-primary btn-sm">
					<span class="fa fa-save fa-lg"></span> <font>保存</font>
				</button>
				<button type="button" data-ns="goexamQuery"
					onclick="resetForm(this),reSetcontent()" class="btn btn-link">
					<span class="fa fa-rotate-left"></span>
				</button>
				<button type="button" name="dodataBaseQuery.do"
					onclick="goBack(this)" class="btn btn-link">
